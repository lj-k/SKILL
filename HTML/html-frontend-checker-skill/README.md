...
综合 HTML 前端检查工具，基于 40+ 个历史 bug 整理而成，与具体项目解耦、可直接应用于任意 HTML 文档。
...
| 版本 | 日期 | 变更 |
|------|------|------|
| v0.01 | 2026-08-14 | 初始版本，80+ 检查项，基于 40+ 历史 bug |
| v0.02 | 2026-08-16 | 新增响应式级联顺序检查；修复 3 类误报（oldId/scroll-spy硬编码/侧栏标题文本）+ 跨选择器级联误报 |
| v0.03 | 2026-08-20 | 新增检查：`callout不包裹子节标题`（栈式解析，防 div 配对盲区）、`figure id 唯一性(fig-)`、`openImageModal引用有效性` |
| v0.04 | 2026-08-20 | 去项目化：移除所有具体项目名、项目字段与版本号标注，全部检查与文档泛化为通用 bug 模式 |
